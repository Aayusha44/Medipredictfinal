...
def parkinson_predict():
    try:
        # Explicit 22 features (EXACT ORDER)
        features = [
            float(request.form.get("MDVP_Fo")),
            float(request.form.get("MDVP_Fhi")),
            float(request.form.get("MDVP_Flo")),
            float(request.form.get("MDVP_Jitter")),
            float(request.form.get("MDVP_JitterAbs")),
            float(request.form.get("MDVP_RAP")),
            float(request.form.get("MDVP_PPQ")),
            float(request.form.get("Jitter_DDP")),
            float(request.form.get("MDVP_Shimmer")),
            float(request.form.get("MDVP_Shimmer_dB")),
            float(request.form.get("Shimmer_APQ3")),
            float(request.form.get("Shimmer_APQ5")),
            float(request.form.get("MDVP_APQ")),
            float(request.form.get("Shimmer_DDA")),
